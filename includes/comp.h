...
class Comp final
{
    ...
    void createVisual(Microsoft::WRL::ComPtr<IDCompositionVisual2> &visual, const Microsoft::WRL::ComPtr<IDCompositionVirtualSurface> &content);
    void createSurface(Microsoft::WRL::ComPtr<IDCompositionVirtualSurface> &surface);
    void createVisualSurfacePair(Microsoft::WRL::ComPtr<IDCompositionVisual2> &visual, Microsoft::WRL::ComPtr<IDCompositionVirtualSurface> &surface);
